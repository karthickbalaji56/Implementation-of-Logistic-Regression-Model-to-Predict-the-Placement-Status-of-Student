...
## Algorithm
Step 1: Load the dataset and separate it into input features and target variable.

Step 2: Split the dataset into training and testing sets and apply feature scaling.

Step 3: Create the Logistic Regression model and train it using the training data.

Step 4: Make predictions on the test data, evaluate the model performance, and predict placement for new student data.
...
<img width="656" height="451" alt="image" src="https://github.com/user-attachments/assets/0ff47b49-4dfb-43b8-9338-a183b7871505" />
